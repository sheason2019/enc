...
class AccountSecret extends $pb.GeneratedMessage {
  ...
  factory AccountSecret.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AccountSecret.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AccountSecret',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  AccountSecret copyWith(void Function(AccountSecret) updates) =>
      super.copyWith((message) => updates(message as AccountSecret))
          as AccountSecret;
  ...
  static $pb.PbList<AccountSecret> createRepeated() =>
      $pb.PbList<AccountSecret>();
  @$core.pragma('dart2js:noInline')
  static AccountSecret getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AccountSecret>(create);
  static AccountSecret? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get ecdhPubKey => $_getSZ(0);
  @$pb.TagNumber(1)
  set ecdhPubKey($core.String v) {
    $_setString(0, v);
  }
...
class AccountIndex extends $pb.GeneratedMessage {
  ...
  factory AccountIndex.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AccountIndex.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AccountIndex',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'ecdhPubKey')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AccountIndex copyWith(void Function(AccountIndex) updates) =>
      super.copyWith((message) => updates(message as AccountIndex))
          as AccountIndex;
  ...
  static $pb.PbList<AccountIndex> createRepeated() =>
      $pb.PbList<AccountIndex>();
  @$core.pragma('dart2js:noInline')
  static AccountIndex getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AccountIndex>(create);
...
class AccountSnapshot extends $pb.GeneratedMessage {
  ...
  factory AccountSnapshot.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AccountSnapshot.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AccountSnapshot',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..aOM<AccountIndex>(1, _omitFieldNames ? '' : 'index',
        subBuilder: AccountIndex.create)
    ..aOS(2, _omitFieldNames ? '' : 'username')
    ..aOS(3, _omitFieldNames ? '' : 'avatarUrl')
    ..m<$core.String, PortableService>(4, _omitFieldNames ? '' : 'serviceMap',
        protoName: 'serviceMap',
        entryClassName: 'AccountSnapshot.ServiceMapEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: PortableService.create,
        valueDefaultOrMaker: PortableService.getDefault,
        packageName: const $pb.PackageName('ENC'))
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AccountSnapshot copyWith(void Function(AccountSnapshot) updates) =>
      super.copyWith((message) => updates(message as AccountSnapshot))
          as AccountSnapshot;
  ...
  static $pb.PbList<AccountSnapshot> createRepeated() =>
      $pb.PbList<AccountSnapshot>();
  @$core.pragma('dart2js:noInline')
  static AccountSnapshot getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AccountSnapshot>(create);
  static AccountSnapshot? _defaultInstance;

  @$pb.TagNumber(1)
  AccountIndex get index => $_getN(0);
  @$pb.TagNumber(1)
  set index(AccountIndex v) {
    setField(1, v);
  }
...
class PortableService extends $pb.GeneratedMessage {
  ...
  factory PortableService.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortableService.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortableService',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortableService copyWith(void Function(PortableService) updates) =>
      super.copyWith((message) => updates(message as PortableService))
          as PortableService;
  ...
  static $pb.PbList<PortableService> createRepeated() =>
      $pb.PbList<PortableService>();
  @$core.pragma('dart2js:noInline')
  static PortableService getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortableService>(create);
...
class PortableSecretBox extends $pb.GeneratedMessage {
  ...
  factory PortableSecretBox.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortableSecretBox.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortableSecretBox',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(
        1, _omitFieldNames ? '' : 'cipherData', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'nonce', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'mac', $pb.PbFieldType.OY)
    ..aOM<AccountIndex>(4, _omitFieldNames ? '' : 'sender',
        subBuilder: AccountIndex.create)
    ..aOM<AccountIndex>(5, _omitFieldNames ? '' : 'receiver',
        subBuilder: AccountIndex.create)
    ..e<EncryptType>(
        6, _omitFieldNames ? '' : 'encryptType', $pb.PbFieldType.OE,
        defaultOrMaker: EncryptType.ENCRYPT_TYPE_NONE,
        valueOf: EncryptType.valueOf,
        enumValues: EncryptType.values)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortableSecretBox copyWith(void Function(PortableSecretBox) updates) =>
      super.copyWith((message) => updates(message as PortableSecretBox))
          as PortableSecretBox;
  ...
  static $pb.PbList<PortableSecretBox> createRepeated() =>
      $pb.PbList<PortableSecretBox>();
  @$core.pragma('dart2js:noInline')
  static PortableSecretBox getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortableSecretBox>(create);
  static PortableSecretBox? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get cipherData => $_getN(0);
  @$pb.TagNumber(1)
  set cipherData($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
...
class PortableOperation extends $pb.GeneratedMessage {
  ...
  factory PortableOperation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortableOperation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortableOperation',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'clock', $pb.PbFieldType.O3)
    ..e<OperationType>(5, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
        defaultOrMaker: OperationType.UNKNOWN_OPEARTION,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortableOperation copyWith(void Function(PortableOperation) updates) =>
      super.copyWith((message) => updates(message as PortableOperation))
  ...
  static $pb.PbList<PortableOperation> createRepeated() =>
      $pb.PbList<PortableOperation>();
  @$core.pragma('dart2js:noInline')
  static PortableOperation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortableOperation>(create);
...
class PortableConversation extends $pb.GeneratedMessage {
  ...
  factory PortableConversation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortableConversation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortableConversation',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..e<ConversationType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
        defaultOrMaker: ConversationType.CONVERSATION_UNKNOWN,
        valueOf: ConversationType.valueOf,
        enumValues: ConversationType.values)
    ..pc<AccountSnapshot>(
        2, _omitFieldNames ? '' : 'members', $pb.PbFieldType.PM,
        subBuilder: AccountSnapshot.create)
    ..aOM<AccountSnapshot>(3, _omitFieldNames ? '' : 'owner',
        subBuilder: AccountSnapshot.create)
    ..aOS(4, _omitFieldNames ? '' : 'remoteUrl')
    ..p<$core.List<$core.int>>(
        5, _omitFieldNames ? '' : 'declaredSecrets', $pb.PbFieldType.PY)
    ..aOM<AccountIndex>(6, _omitFieldNames ? '' : 'agent',
        subBuilder: AccountIndex.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PortableConversation clone() =>
      PortableConversation()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortableConversation copyWith(void Function(PortableConversation) updates) =>
      super.copyWith((message) => updates(message as PortableConversation))
          as PortableConversation;
  ...
  static $pb.PbList<PortableConversation> createRepeated() =>
      $pb.PbList<PortableConversation>();
  @$core.pragma('dart2js:noInline')
  static PortableConversation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortableConversation>(create);
...
class PortableMessage extends $pb.GeneratedMessage {
  ...
  factory PortableMessage.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortableMessage.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortableMessage',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'uuid')
    ..e<MessageType>(
        2, _omitFieldNames ? '' : 'messageType', $pb.PbFieldType.OE,
        defaultOrMaker: MessageType.MESSAGE_TYPE_UNKNOWN,
        valueOf: MessageType.valueOf,
        enumValues: MessageType.values)
    ..aOS(3, _omitFieldNames ? '' : 'content')
    ..aOM<AccountSnapshot>(4, _omitFieldNames ? '' : 'sender',
        subBuilder: AccountSnapshot.create)
    ..aOM<PortableConversation>(5, _omitFieldNames ? '' : 'conversation',
        subBuilder: PortableConversation.create)
    ..pc<PortableMessageState>(
        6, _omitFieldNames ? '' : 'messageStates', $pb.PbFieldType.PM,
        subBuilder: PortableMessageState.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortableMessage copyWith(void Function(PortableMessage) updates) =>
      super.copyWith((message) => updates(message as PortableMessage))
          as PortableMessage;
  ...
  static $pb.PbList<PortableMessage> createRepeated() =>
      $pb.PbList<PortableMessage>();
  @$core.pragma('dart2js:noInline')
  static PortableMessage getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortableMessage>(create);
  ...
  @$pb.TagNumber(5)
  set conversation(PortableConversation v) {
    setField(5, v);
  }
...
class PortableMessageState extends $pb.GeneratedMessage {
  ...
  factory PortableMessageState.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortableMessageState.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortableMessageState',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..aOM<AccountIndex>(1, _omitFieldNames ? '' : 'accountIndex',
        subBuilder: AccountIndex.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PortableMessageState clone() =>
      PortableMessageState()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortableMessageState copyWith(void Function(PortableMessageState) updates) =>
      super.copyWith((message) => updates(message as PortableMessageState))
          as PortableMessageState;
  ...
  static $pb.PbList<PortableMessageState> createRepeated() =>
      $pb.PbList<PortableMessageState>();
  @$core.pragma('dart2js:noInline')
  static PortableMessageState getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortableMessageState>(create);
  static PortableMessageState? _defaultInstance;

  @$pb.TagNumber(1)
  AccountIndex get accountIndex => $_getN(0);
  @$pb.TagNumber(1)
  set accountIndex(AccountIndex v) {
    setField(1, v);
  }
...
class SignWrapper extends $pb.GeneratedMessage {
  ...
  SignWrapper._() : super();
  factory SignWrapper.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SignWrapper.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SignWrapper',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'ENC'),
      createEmptyInstance: create)
    ..aOM<AccountIndex>(1, _omitFieldNames ? '' : 'signer',
        subBuilder: AccountIndex.create)
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'buffer', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'sign', $pb.PbFieldType.OY)
    ..aOB(4, _omitFieldNames ? '' : 'encrypt')
    ..e<ContentType>(
        5, _omitFieldNames ? '' : 'contentType', $pb.PbFieldType.OE,
        defaultOrMaker: ContentType.CONTENT_BUFFER,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SignWrapper copyWith(void Function(SignWrapper) updates) =>
      super.copyWith((message) => updates(message as SignWrapper))
          as SignWrapper;
  ...
  @$core.pragma('dart2js:noInline')
  static SignWrapper getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SignWrapper>(create);
  static SignWrapper? _defaultInstance;

  @$pb.TagNumber(1)
  AccountIndex get signer => $_getN(0);
  @$pb.TagNumber(1)
  set signer(AccountIndex v) {
    setField(1, v);
  }
